...
public class MainPage extends JFrame {
    ...
    private JButton btnDashboard, btnStuds, btnGrades, btnAttendance;
    ...
    private CardLayout cardLayout;
        ...
        MainPage(){
            ...
            btnStuds.setFont(new Font("Arial", Font.PLAIN, 15));
            ...
            btnGrades.setFont(new Font("Arial", Font.PLAIN, 15));
            ...
            btnAttendance.setFont(new Font("Arial", Font.PLAIN, 15));
